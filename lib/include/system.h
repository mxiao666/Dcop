...
*****************************************************************************/
    s32 OS_SafeSystem(char *pcCmd, char *argv[],
                      u32 uiTimeOut, s32 *piScriptRet);
...
*****************************************************************************/
    s32 OS_SafeSystemSub(char *pcCmd, char *argv[],
                         u32 uiTimeOut, s32 *piScriptRet, pid_t *ptChildPid);
